...
# app.config["SQLALCHEMY_DATABASE_URI"] = "mysql+pymysql://admin:appwarepassword@appware-db.csx7kkyqt3cj.ap-southeast-1.rds.amazonaws.com:3306/appware"
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://appware:ManoahR#%7@127.0.0.1/appware'
